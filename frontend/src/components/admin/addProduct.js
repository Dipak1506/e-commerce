    ...
    <div>
      ...
      <div className={addPcss.contentDiv}>
        ...
        <div className={addPcss.mainContent}>
          <span>
            Product Name<span className={addPcss.required}>*</span>
          </span>
          <br />
          <input
            type="text"
            ref={productName}
            className={addPcss.input}
            placeholder="Enter product name"
          />
          <br />
          <span>
            Product Quantity<span className={addPcss.required}>*</span>
          </span>
          <br />
          <input
            type="number"
          ...
          <br />
          <span>
            Product Price<span className={addPcss.required}>*</span>
          </span>
          <br />
          <input
            type="text"
          ...
          <br />
          <span>
            Product Previous Price<span className={addPcss.required}>*</span>
          </span>
          <br />
          <input
            type="text"
            ref={productPreviousPrice}
            className={addPcss.input}
            placeholder="Enter product previous price in INR"
          />
          <br />
          <span>
            Product Description<span className={addPcss.required}>*</span>
          </span>
          <br />
          <textarea
          ...
          <br />
          <span>
            Product Main Image<span className={addPcss.required}>*</span>
          </span>
          <br />
          <input ref={image} type="file" />
          <br />
          <span>
            Product Other Images<span className={addPcss.required}>*</span>
          </span>
          <br />
          <input ref={otherImages} type="file" multiple />
          <p className={addPcss.btnP}>
            <button
              className={addPcss.btn}
              onClick={() => {
                // //setShowLoading(true);
                // alert("Please wait....");
                ...
                // formData.append(
                //   "previous_price",
                //   productPreviousPrice.current.value
                // );
                // formData.append("quantity", productQuantity.current.value);
                // formData.append(
                //   "description",
